...
namespace Estate.UI.Controllers
{
    ...
    public class SituationApiController : Controller
    {
        public IActionResult Index()
        {
            ...
            var request = httpClient.GetAsync("https://localhost:7254/api/situation").Result;
        ...
        public IActionResult Create(Situation data)
        {
            ...
            var request = httpClient.PostAsync("https://localhost:7254/api/situation", content).Result;
        ...
        public IActionResult Delete(int id)
        {
            ...
            var request = httpClient.DeleteAsync($"https://localhost:7254/api/situation/{id}").Result;
            return RedirectToAction("Index");
        }
        ...
        public IActionResult Update(int id)
        {
            ...
            var request = httpClient.GetAsync($"https://localhost:7254/api/situation/{id}").Result;
        ...
        public IActionResult Update(Situation data)
        {
            ...
            var request = httpClient.PutAsync("https://localhost:7254/api/situation", content).Result;
            return RedirectToAction("Index");
        }
